...
#ifndef __BATMOBILEV1DATA_H__
#define __BATMOBILEV1DATA_H__
#include <set>
#include <vector>
#include <map>
...
class BatMobileV1_NeighNode;

class BatMobileV1_OrigNode : public cObject
{
  public:
    ManetAddress orig;
    uint32_t totalRec;
    BatMobileV1_NeighNode *router;
    BatMobileV1_BatmanIf* batmanIf;
    ...
    std::vector<BatMobileV1_HnaElement> hna_buff;
    uint16_t last_real_seqno;   /* last and best known squence number */
    uint8_t last_ttl;         /* ttl of last received packet */
    uint8_t num_hops;
    std::vector<BatMobileV1_NeighNode *> neigh_list;

  public:
    void clear();
    BatMobileV1_OrigNode();
    ~BatMobileV1_OrigNode();
    virtual std::string info() const;
};


class BatMobileV1_NeighNode : public cObject
{
  public:
    ManetAddress addr;
    ...
    BatMobileV1_OrigNode *owner_node;
    BatMobileV1_BatmanIf *if_incoming;
    void clear();
    ~BatMobileV1_NeighNode();
    BatMobileV1_NeighNode() {clear();}
    BatMobileV1_NeighNode(BatMobileV1_OrigNode *, BatMobileV1_OrigNode *, const ManetAddress &, BatMobileV1_BatmanIf *, const uint32_t&, const uint32_t&);
    virtual std::string info() const;
};


class BatMobileV1_ForwNode                       /* structure for forw_list maintaining packets to be send/forwarded */
{
  public:
    simtime_t send_time;
    uint8_t   own;
    BatMobileV1_BatmanPacket *pack_buff;
...
class BatMobileV1_GwNode
{
  public:
    ...
    simtime_t deleted;
  public:
    BatMobileV1_GwNode() : orig_node(NULL), gw_port(0), gw_failure(0), last_failure(0), deleted(0) {}
};
...
class BatMobileV1_HnaTask
{
  ...
  public:
    BatMobileV1_HnaTask() : netmask(0), route_action(0) {}
};

class BatMobileV1_HnaLocalEntry
{
  public:
    ManetAddress addr;
    short unsigned int netmask;
...
class HnaGlobalEntry
{
  public:
    ManetAddress addr;
    short unsigned int netmask;
    BatMobileV1_OrigNode *curr_orig_node;
    std::vector<BatMobileV1_OrigNode *> orig_list;
