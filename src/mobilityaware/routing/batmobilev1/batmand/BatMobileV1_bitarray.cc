...
/* clear the bits */
void BatMobileV1::bit_init(std::vector<TYPE_OF_WORD> &seq_bits) {
    int i;
...
uint8_t BatMobileV1::get_bit_status(std::vector<TYPE_OF_WORD> &seq_bits, uint16_t last_seqno, uint16_t curr_seqno) {
...
void BatMobileV1::bit_mark(std::vector<TYPE_OF_WORD> &seq_bits, int32_t n) {
...
void BatMobileV1::bit_shift(std::vector<TYPE_OF_WORD> &seq_bits, int32_t n) {
    int32_t word_offset, word_num;
    int32_t i;
...
char BatMobileV1::bit_get_packet(std::vector<TYPE_OF_WORD> &seq_bits, int16_t seq_num_diff, int8_t set_mark)
{
    int i;
...
int BatMobileV1::bit_packet_count(std::vector<TYPE_OF_WORD> &seq_bits)
{
    int i, hamming = 0;
    TYPE_OF_WORD word;
...
uint8_t BatMobileV1::bit_count(int32_t to_count)
{
    uint8_t hamming = 0;
